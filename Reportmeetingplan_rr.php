		...
		<article id="content2">
			<div class="wrapper">
				<section class="col-4-4">
					<h2><font color="#0000FF" >Meetings Plan Report</font></h2>

<b>Sr. No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Society Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Meeting No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aggenda&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Meeting Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Duration</b>
<?php
$co = 1;
...
<input  type="reset" class="button1" value="Clear">
      <input name="cnic_sub1_frm" class="button1" type="submit" value="Add"></td>
