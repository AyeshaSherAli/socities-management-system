		...
		<article id="content2">
			<div class="wrapper">
				<section class="col-4-4">
					<h2><font color="black" >Performance Monitoring Form</font></h2>
...
if(empty($error))
 {
$Query = mysql_query('Select * FROM  feedback_s');
 ...
 while($rows=mysql_fetch_array($Query)){
     echo "<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" .$co. "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $rows['ranking_info'] . "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $rows['feedback_text'];
