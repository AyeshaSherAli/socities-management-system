	...
	<div class="body1">
		<div class="body5">
			<div class="main zerogrid">
				<header>
  <h2><a href="index.php"><font color="#FFFFFF" size="+3" style="font-size:52px">  UE Societies Management System</font></a></h2>
				  <nav>
...
<!-- content -->
         ...
         <li><a href="meetingHome.php">Create Meating</a></li> 
		...
		<article id="content2">
			<div class="wrapper">
				<section class="col-2-3">
					<h2 style="color:black";>Event Notification Form</h2>
